...
app.config.update({
    ...
    'TIME_LAPSE_FOLDER': os.path.expanduser(os.getenv('TIME_LAPSE_FOLDER', os.path.join(BASE_DIR, 'media', 'time_lapse'))),
    'PLANT_SNAPSHOTS_FOLDER': os.path.expanduser(os.getenv('PLANT_SNAPSHOTS_FOLDER', os.path.join(BASE_DIR, 'media', 'plant_snapshots'))),
...
def analyze_images():
    try:
        script_path = os.path.join(BASE_DIR, 'src', 'models', 'analyze_image.py')
...
if __name__ == "__main__":
    ...
    try:
        ...
        pass  # Ensure proper cleanup if needed